...
def preprocess(train_df):
    ...
    dropna_col = train_df.columns[train_df.isna().any()].tolist()
...
dropna_col = preprocess(train_df)
...
cat_cols = list(set(cat_cols) - set(dropna_col))
print(cat_cols)
...
num_cols = list(set(num_cols) - set(dropna_col))
print(num_cols)
...
sub_df.to_csv("drop_missing.csv", index=False)
